...
//   non-obvious-insight— surface something the developer would miss from the
//                        scores alone (e.g. "Both states score 72-74 but
//                        IL's program closes 14 months sooner — timing
//                        risk favors MN").
//
...
Your job is to add value the table cannot. Pick exactly ONE of these three insight types and produce that:
  ...
  3. NON-OBVIOUS-INSIGHT — surface a finding the developer would miss reading the scores alone. Examples: a runway difference that swamps a small score gap; a stage mismatch that changes the timing math; a program-cap concentration risk; a sub-score divergence (high offtake masking low site).
...
OUTPUT: Respond ONLY with a valid JSON object. No preamble, no markdown fences, no trailing text. Exact schema:
{
  "insightType": "Recommendation" | "Differentiator" | "Non-obvious insight",
