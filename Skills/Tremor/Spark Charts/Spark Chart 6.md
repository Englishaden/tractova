              ...
              <div className="flex items-center space-x-1.5">
                ...
                <span
                  className={classNames(
                    ...
                    'inline-flex items-center rounded px-2 py-0.5 text-tremor-label',
                  )}
                >
                  {item.change}
                </span>
              </div>
              <dd className="mt-0.5 truncate text-tremor-label text-tremor-content dark:text-dark-tremor-content">
                {item.description}
              </dd>
            </div>
            <SparkAreaChart
