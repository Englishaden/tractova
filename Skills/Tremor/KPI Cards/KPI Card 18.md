  ...
  return (
    <Card>
      <div className="flex items-center justify-between">
        ...
        <dd className="rounded-tremor-small bg-tremor-background-subtle px-2 py-0.5 text-tremor-label font-medium text-tremor-content-emphasis dark:bg-dark-tremor-background-subtle dark:text-dark-tremor-content-emphasis">
