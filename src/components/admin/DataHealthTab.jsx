...
const FRESHNESS_CONFIG = {
  ...
  county_geospatial_data: { label: 'County Geospatial (NWI complete · SSURGO 2,405/3,143)', mode: 'live', icon: '🌿', field: 'last_cron_success', fallbackField: 'last_updated', staleField: null, thresholds: [45, 120] },
  hosting_capacity_data: { label: 'Hosting Capacity', mode: 'live', icon: '🔋', field: 'last_cron_success', fallbackField: 'newest_fetch', staleField: null, thresholds: [45, 120] },
