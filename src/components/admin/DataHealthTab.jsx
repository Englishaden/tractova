...
const FRESHNESS_CONFIG = {
  ...
  county_geospatial_data: { label: 'County Geospatial (SSURGO live · NWI partial)', mode: 'live', icon: '🌿', field: 'last_cron_success', fallbackField: 'last_updated', staleField: null, thresholds: [45, 120] },
