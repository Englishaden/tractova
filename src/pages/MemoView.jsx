          ...
          {scenario && scenario.outputs && (
            <div className="rounded-xl px-6 py-5 mb-8 relative overflow-hidden"
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                ...
                <ScenarioMetric label="IRR · project" value={scenario.outputs.irr != null && scenario.outputs.irr > 0 ? `${(scenario.outputs.irr * 100).toFixed(1)}%` : '—'} />
                <ScenarioMetric label="IRR · equity" value={scenario.outputs.equityIrr != null && scenario.outputs.equityIrr > 0 ? `${(scenario.outputs.equityIrr * 100).toFixed(1)}%` : '—'} />
