  ...
  return (
    <div className="mt-4 space-y-3">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
        {/* Health gauge — animated tech panel (mesh + scan + pulse rings),
            mirrors Library WeeklySummaryCard. CSS keyframes live in index.css. */}
        {(() => {
          ...
          return (
            ...
            >
              ...
              <p className="relative text-[9px] font-bold uppercase tracking-wider text-gray-600 mb-1">Health</p>
              <div className="relative w-14 h-14">
                ...
                <svg viewBox="0 0 36 36" className="relative w-14 h-14 -rotate-90">
                ...
                <span className="absolute inset-0 flex items-center justify-center text-lg font-bold tabular-nums" style={{ color: ringStroke }}>{healthScore}</span>
              </div>
