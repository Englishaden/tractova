      ...
      <article className="max-w-3xl mx-auto">
        ...
        <Section eyebrow="06" title="Important — disclaimers about data, scoring, and AI commentary">
          ...
          <List>
            ...
            <Li>
              <strong>BESS revenue rates are seeded constants and may be
              materially out of date.</strong> Battery Energy Storage System
              revenue projections (capacity payments, demand charges, arbitrage
              spreads) are calibrated against ISO/RTO capacity-market clearing
              results as of a specific seed date, displayed visibly on the BESS
              revenue panel as an "as of [year-month]" stamp. These rates
              <strong> do not auto-refresh</strong>. ISO capacity prices have
              historically swung 2&ndash;9&times; year over year (e.g., PJM's
              2026/2027 base residual auction cleared at materially different
              levels than prior cycles). Always verify against your ISO's most
              recent capacity-auction results and your specific utility's
              demand-charge tariff schedule before relying on a BESS revenue
              projection for any business decision.
            </Li>
            <Li>
