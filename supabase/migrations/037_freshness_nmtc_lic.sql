-- Migration 037: get_data_freshness() — add nmtc_lic_data block
--
-- Migration 036 added the nmtc_lic_data table (IRA §48(e) Category 1 LIC
-- eligibility derived from raw Census ACS per CDFI Fund methodology).
-- This migration extends the freshness RPC so the Admin Data Health
-- panel surfaces a card for it, driven by last_cron_success from cron_runs.
--
