-- Migration 035: get_data_freshness() — add hud_qct_dda_data block
--
-- Migration 034 added the hud_qct_dda_data table (HUD User QCT 2026 + DDA
-- 2026 LIHTC designation layers). This migration extends the freshness RPC
-- so the Admin Data Health panel surfaces a card for it, driven by
-- last_cron_success from cron_runs.
--
