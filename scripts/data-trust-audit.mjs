...
const REGISTRY = [
  ...
  },
  {
    ...
    file: 'src/lib/revenueEngine.js', line: 213,
    tier: 'B',
    source: 'PJM RPM, NYISO ICAP, ISO-NE FCM, CAISO RA clearing prices + Tractova state allocation',
    vintage: '2026-04',
    nFields: 17,
    risk: 'high',
    notes: 'ISO clearing prices swing 2-9× year over year. BESS_RATES_AS_OF disclosure flags this in UI but the constants drift fast. Need annual refresh against actual ISO auction results. PJM RPM 2026/2027 BRA clearing was in 2025; should re-anchor.',
  },
  {
